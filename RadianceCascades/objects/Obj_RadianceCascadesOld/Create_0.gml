...
global.rc_cascade_branch   = 4.0; // multiplier for probes / intervals.
...
show_debug_message(  "Cascade Angular: {0}", string(global.rc_cascade_angular));
show_debug_message(  "Cascade Interval: {0}", string(global.rc_cascade_interval));
